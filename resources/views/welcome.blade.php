            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="items-center flex">
                                <img src="/PayPal.svg.png" style="width: 180px; height:100px" alt="">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="items-center flex">
                                <img src="/paymob.png" style="width: 180px; height:100px" alt="">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="items-center flex">
                                ...
                                <a style="display: block" href="/paytabs-form" class="btn btn-primary ml-5 pull-right">Paytabs From</a>
                            </div>
                        </div>
                    </div>
                </div>
